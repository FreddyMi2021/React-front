      ...
      <div className="w-full shadow-md px-4">
        <ul
          ...
          <li className="-mb-px last:mr-0 flex-wrap text-center">
            ...
            >
              <BiCreditCard
                className='text-center text-gray-500 relative left-12'
          ...
          <div className="tab-content tab-space">
            <div className={openTab === 1 ? 'block' : 'hidden'} id='link1'>
              <div className="block pb-32 md:pb-0 md:flex flex-row">
                ...
                <div className="w-full md:w-1/2">
                  <StripePayment price={props.priceInEuro} updatePaymentTicket={props.updatePaymentTicket} ticket={ props.ticket } />
                </div>
              </div>
            </div>
