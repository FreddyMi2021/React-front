...
const HeaderPayment = (props) => {
  ...
  useEffect(() => {
    setPriceInEuro( Math.ceil( ( Math.ceil(props.price) * 500 ) / Math.ceil(2000000) ) )
    props.setPriceInEuro(Math.ceil( ( Math.ceil(props.price) * 500 ) / Math.ceil(2000000) ))
  })
    ...
    <div className="w-full h-full md:pt-12 xl:pt-14  px-8">
      <div className="w-full pt-8 md:pt-0">
          <div className="w-full">
              <div className="w-full pb-14 md:pb-0  md:flex flex-row text-gray-700">
                <div className="md:w-2/3 pb-8">
                  ...
                  <span className="text-base font-bold block">Payment by slice</span>
                  ...
                  <p className="inline text-3xl font-bold text-gray-500 mb-6">
                    ...
                    <span className="text-black">{ priceInEuro !== null ? priceInEuro : "0" } <BiEuro className="inline-block mb-1" /></span>
                  </p>
                </div>
                <div className="relative text-right md:w-1/3">
