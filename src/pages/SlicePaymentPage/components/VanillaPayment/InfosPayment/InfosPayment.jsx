                  ...
                  <div className="relative py-4 md:py-0 text-right md:w-1/3">
                    {
                      vanillaUrl === null ? (
                        ...
                        <a href={ vanillaUrl } className="text-center uppercase md:mb-4 w-full md:w-32 py-2 rounded-md font-semibold text-white bg-green-700 ring-4 ring-green-300 inline-block 2xl:mr-4">
                          Pay
                        </a>
                      )
                    }
                    <button className="text-center uppercase w-full md:w-32 py-2 rounded-md font-semibold text-white bg-pink-700 ring-4 ring-pink-300 mt-4" onClick={ () => props.cancelPaymentMode() }>
                      Cancel
                    </button>
                  </div>
                </div>
